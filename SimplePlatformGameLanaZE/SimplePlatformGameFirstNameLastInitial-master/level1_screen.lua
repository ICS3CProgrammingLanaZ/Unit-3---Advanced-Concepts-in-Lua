...
--You win sound
local youWin = audio.loadSound("Sounds/Grease_Monkey.mp3")
...
local function ReplaceCharacter()
    ...
    -- add physics body
    physics.addBody( character, "dynamic", { density=3, friction=1.5, bounce=0, rotation=0 } )
    ...
    if ( event.phase == "began" ) then
        ...
        if (event.target.myName == "door") then
            ...
            if (questionsAnswered == 3) then
                -- after getting 3 questions right, go to the you win screen and play you win sound
